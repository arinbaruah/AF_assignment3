...
- The first method as delineated in @sec-initial created a single "5-year" forecast by using the test dataset to obtain the model performance metric in the form RMSE.
